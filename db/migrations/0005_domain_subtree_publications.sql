...
COMMENT ON VIEW publication_candidates IS
  'Compiler projection only: stable identifier + public entity id + display reason codes. Domain subtree matches publish separately so the client preserves matching semantics without widening each tuple.';
