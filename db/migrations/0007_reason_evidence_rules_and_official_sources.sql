...
INSERT INTO reason_evidence_requirements (
  ...
  ('CP06','company','documented-action','historical-event',
   ...
   true,1,NULL,'none'),
  ('CP07','company','documented-action','historical-event',
   'The company/organization appears on the official participant or endorser record of a specifically documented Palestine solidarity campaign.',
   'An employee''s participation does not qualify the company unless the campaign record names the company/organization itself. Use the campaign source as evidence when a specific campaign is recorded.',
   true,1,NULL,'none'),
